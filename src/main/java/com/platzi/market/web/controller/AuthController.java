...
import com.platzi.market.domain.dto.AuthencationRequest;
...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponse> createToken(@RequestBody AuthencationRequest request) {
        try {
